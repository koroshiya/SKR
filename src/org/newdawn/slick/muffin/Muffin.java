...
public interface Muffin {
	 ...
	 */
	public abstract void saveFile(HashMap<Object, Object> data, String fileName) throws IOException;
	 ...
	 */
	public abstract HashMap<Object, Object> loadFile(String fileName) throws IOException;
}
